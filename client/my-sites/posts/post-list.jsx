...
const Posts = localize(
	class extends Component {
			...
			if ( search ) {
				return (
					<NoResults
						...
						text={ translate( 'No posts match your search for {{searchTerm/}}.', {
							components: {
		...
		renderLoadingPlaceholders = () => {
			return <PostPlaceholder key={ 'placeholder-scroll-' + this.props.query.page } />;
		};
		...
		render() {
			...
			if ( posts.length && this.props.hasSites ) {
				...
				postList = <div className="posts__list">{ placeholders }</div>;
			}
